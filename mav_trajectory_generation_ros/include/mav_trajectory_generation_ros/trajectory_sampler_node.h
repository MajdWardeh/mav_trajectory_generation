...
class TrajectorySamplerNode {
 ...
 private:
  ...
  void samplePartialTrajectoryCallback(const std_msgs::Float64MultiArray::ConstPtr& msg);
  ...
  ros::Subscriber getTrajectoryChunk_sub_;
  ros::Publisher sampledTrajectoryChunk_pub_;
